...
class ContactEditHorizontal extends StatefulWidget {
  final Contact contact;
  ContactEditHorizontal({@required this.contact});

  @override
  ContactEditHorizontalState createState() {
    return ContactEditHorizontalState();
  }
}

class ContactEditHorizontalState extends State<ContactEditHorizontal> {
