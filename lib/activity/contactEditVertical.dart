...
class ContactEditVertical extends StatefulWidget {
  final Contact contact;
  ContactEditVertical({@required this.contact});

  @override
  ContactEditVerticalState createState() {
    return ContactEditVerticalState();
  }
}

class ContactEditVerticalState extends State<ContactEditVertical> {
